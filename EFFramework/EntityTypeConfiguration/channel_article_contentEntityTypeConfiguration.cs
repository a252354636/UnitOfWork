...
{   
    /// <summary>
    /// 实体-channel_article_content 
    /// </summary>
	public class channel_article_contentEntityTypeConfiguration :  EntityTypeConfiguration<channel_article_content>
    {
		public channel_article_contentEntityTypeConfiguration()
		{
			/// <summary>
        /// 
        /// </summary>
        ...
        Property(s=>s.update_time).IsOptional();
			...
			//配置表名称
			ToTable("dt_channel_article_content");
