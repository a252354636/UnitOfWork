...
{   
    /// <summary>
    /// 实体-channel_article_photo 
    /// </summary>
	public class channel_article_photoEntityTypeConfiguration :  EntityTypeConfiguration<channel_article_photo>
    {
		public channel_article_photoEntityTypeConfiguration()
		{
			/// <summary>
        /// 
        /// </summary>
        ...
        Property(s=>s.author).IsOptional();
			...
			//配置表名称
			ToTable("dt_channel_article_photo");
