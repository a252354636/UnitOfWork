...
{   
    /// <summary>
    /// 实体-channel_article_video 
    /// </summary>
	public class channel_article_videoEntityTypeConfiguration :  EntityTypeConfiguration<channel_article_video>
    {
		public channel_article_videoEntityTypeConfiguration()
		{
			/// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        Property(s=>s.video_src).IsOptional();
        /// <summary>
        /// 
        /// </summary>
        Property(s=>s.sub_title).IsOptional();
			...
			//配置表名称
			ToTable("dt_channel_article_video");
