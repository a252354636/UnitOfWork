...
{   
    /// <summary>
    /// 实体-channel_article_down 
    /// </summary>
	public class channel_article_downEntityTypeConfiguration :  EntityTypeConfiguration<channel_article_down>
    {
		public channel_article_downEntityTypeConfiguration()
		{
			/// <summary>
        /// 
        /// </summary>
        ...
        Property(s=>s.author).IsOptional();
			...
			//配置表名称
			ToTable("dt_channel_article_down");
